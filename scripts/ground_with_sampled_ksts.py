"""This script can be used to process test data to use the same turns as in
Coca et al.

Seed can be fixed to ensure the examples across the SGD-X variants are grounded
with the same turn and concatenation order is consistent across schema variants.
"""
import json
import logging
import sys
