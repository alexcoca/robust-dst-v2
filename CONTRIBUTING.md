...
Welcome to `robust-dst` contributor's guide.
...
If you experience bugs or general issues with `robust-dst`, please have a look
...
You can help improve `robust-dst` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`robust-dst` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `robust-dst`'s files. While this mechanism can
...
```
conda create -n robust-dst python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/robust-dst.git
   cd robust-dst
   ```
...
5. Install [pre-commit]:
   ...
   `robust-dst` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/robust-dst
[issue tracker]: https://github.com/<USERNAME>/robust-dst/issues
